...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(856, 528)
        MainWindow.setStyleSheet(u"background: radial-gradient(circle, #ff9a9e, #fad0c4);")
        ...
        self.mainSection.setStyleSheet(u"background: url(:/icons/icons/defaultBg.svg);\n"
...
"    background-size: cover;")
        ...
        sizePolicy.setHeightForWidth(self.headSeaction.sizePolicy().hasHeightForWidth())
        self.headSeaction.setSizePolicy(sizePolicy)
        ...
        sizePolicy1.setHeightForWidth(self.showHideButton.sizePolicy().hasHeightForWidth())
        self.showHideButton.setSizePolicy(sizePolicy1)
...
"border: none;")
        ...
        sizePolicy3.setHeightForWidth(self.featureBlock.sizePolicy().hasHeightForWidth())
        self.featureBlock.setSizePolicy(sizePolicy3)
...
"}")
        ...
        sizePolicy4.setHeightForWidth(self.playButton_2.sizePolicy().hasHeightForWidth())
        self.playButton_2.setSizePolicy(sizePolicy4)
...
"}")
        ...
        self.scrollAreaWidgetContents.setGeometry(QRect(0, 0, 192, 461))
        ...
        self.addTrackButton = QPushButton(self.playList)
        self.addTrackButton.setObjectName(u"addTrackButton")
        self.addTrackButton.setMinimumSize(QSize(0, 40))
        font2 = QFont()
